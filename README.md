...
- Releases: use GitHub Releases for private beta milestones.
- Packages: no GitHub Packages are published yet. This repo is distributed as
  source code for invited private beta testers.
- Contributors: generated by GitHub from commit authors; see
  [CONTRIBUTORS.md](./CONTRIBUTORS.md) for the explicit maintainer note.
